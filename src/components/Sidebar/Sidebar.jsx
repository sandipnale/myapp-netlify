...
const Sidebar = ({ sidebatVisible }) => {
    return (

        <div className={`border-end bg-white ${sidebatVisible ? '' : 'd-none'}`} id="sidebar-wrapper">
            <div className="sidebar-heading border-bottom bg-light custom-sidebar-heading">
